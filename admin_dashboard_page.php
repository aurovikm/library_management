               ...
               <div class="main-card">
                    ...
                    <div class="right-side">
                            ...
                            <form class="add-book-form" action="addBookServerPage.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="right-side-form">
                                    <div class="branch">
                                        ...
                                        <input type="radio" name="branch" value="cse">PHY<br>
                                        <input type="radio" name="branch" value="ece">CHEM<br>
                                        <input type="radio" name="branch" value="eee">ZOOLOGY<br>
                                    </div>
                        ...
                        <div id="bookrequest" class="portion" style="display:none;">
                            <p class="heading">Request a book</p>
                        </div>
                    </div>
               </div>
           </div>
